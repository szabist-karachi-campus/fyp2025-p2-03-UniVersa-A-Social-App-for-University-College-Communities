...
import 'addevents_viewmodel.dart';

class AddeventsView extends StackedView<AddeventsViewModel> {
  AddeventsView({Key? key, this.update = false, this.data}) : super(key: key);
  Map? data;
  bool update;
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  text_helper(data: "Event Category"),
                  DropdownButton<String>(
                    value: viewModel.c,
                    items: viewModel.a.map((String value) {
                      return DropdownMenuItem<String>(
                        value: value,
                        child: text_helper(data: value),
                      );
                    }).toList(),
                    onChanged: (String? newValue) {
                      viewModel.c = newValue!;
            ...
            update
                ? button_helper(
                    ...
                    child: text_helper(data: "Update Event"))
                : button_helper(
                    onpress: () => viewModel.add(context),
                    child: text_helper(data: "Add Event"))
          ],
        )));
  }

  @override
  void onViewModelReady(AddeventsViewModel viewModel) {
    if (update) {
      viewModel.title.text = data!["title"];
      viewModel.des.text = data!["des"];
      viewModel.c = data!["cat"];
  ...
  @override
  AddeventsViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      AddeventsViewModel();
}
