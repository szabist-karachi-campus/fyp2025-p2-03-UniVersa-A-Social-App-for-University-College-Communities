...
import 'lostandfound_viewmodel.dart';

class LostandfoundView extends StackedView<LostandfoundViewModel> {
  const LostandfoundView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    LostandfoundViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
      appBar: AppBar(
                                ...
                                child: Container(
                                  ...
                                  child: Image.network(
                                    ...
                                    loadingBuilder: (ctx, child, loading) {
                                      ...
                                      return Center(
                                          child: displaysimpleprogress(ctx));
                                    },
                                  ),
                                ),
                              ),
  ...
  @override
  LostandfoundViewModel viewModelBuilder(BuildContext context) =>
